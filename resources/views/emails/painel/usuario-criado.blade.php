...
<body style="font-family: -apple-system, Segoe UI, Roboto, sans-serif; background: #f5f7fa; padding: 32px;">
  <table cellpadding="0" cellspacing="0" border="0" align="center" width="560" style="background:#fff; border-radius:12px; padding:32px; box-shadow:0 1px 3px rgba(0,0,0,.06);">
    <tr><td>
      <h1 style="margin:0 0 16px; color:#0F766E; font-size:22px;">Bem-vindo(a) ao Painel Shopets</h1>
      <p>Olá <strong>{{ $user->name }}</strong>,</p>
      <p>Sua conta de acesso ao Painel Administrativo foi criada. Use os dados abaixo para entrar:</p>
      <table cellpadding="8" cellspacing="0" border="0" style="background:#f0fdfa; border-radius:8px; margin:18px 0;">
        <tr><td style="font-weight:600; padding-right:10px;">E-mail:</td><td>{{ $user->email }}</td></tr>
